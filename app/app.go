...
import (
	...
	"github.com/anpan2val/anpan-chain/docs"
)
...
func New(
	...
	*/
	...
	app.AnpanchainKeeper = *anpanchainmodulekeeper.NewKeeper(
		appCodec,
		keys[anpanchainmoduletypes.StoreKey],
		keys[anpanchainmoduletypes.MemStoreKey],
		app.GetSubspace(anpanchainmoduletypes.ModuleName),
	)
